...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   check_letter_bonus.c                               :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: yookamot <yookamot@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/01/14 00:21:23 by yookamot          #+#    #+#             */
/*   Updated: 2025/02/22 14:26:47 by yookamot         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	check_letter_x(t_data *data, char *map)
{
	int	i;
	int	x;
...
int	check_letter(t_data *data, char *map)
{
	...
	p = check_letter_p(map);
	e = check_letter_e(map);
	c = check_letter_c(data, map);
	if (invalid != 0 || p != 0 || e != 0 || c != 0)
		return (1);
	return (check_letter_x(data, map));
}
